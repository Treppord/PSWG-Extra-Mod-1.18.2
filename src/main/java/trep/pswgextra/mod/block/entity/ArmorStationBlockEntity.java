...
import trep.pswgextra.mod.recipe.ArmorStationRecipe;
...
public class ArmorStationBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public ArmorStationBlockEntity(BlockPos pos, BlockState state) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch (index) {
                    case 0: return ArmorStationBlockEntity.this.progress;
                    case 1: return ArmorStationBlockEntity.this.maxProgress;
                    case 2: return ArmorStationBlockEntity.this.fuelTime;
                    case 3: return ArmorStationBlockEntity.this.maxFuelTime;
                    default: return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    case 0: ArmorStationBlockEntity.this.progress = value; break;
                    case 1: ArmorStationBlockEntity.this.maxProgress = value; break;
                    case 2: ArmorStationBlockEntity.this.fuelTime = value; break;
                    case 3: ArmorStationBlockEntity.this.maxFuelTime = value; break;
                }
            }
    ...
    private static boolean hasFuelInFuelSlot(ArmorStationBlockEntity entity) {
        return !entity.getStack(0).isEmpty();
    }

    private static boolean isConsumingFuel(ArmorStationBlockEntity entity) {
    ...
    private static boolean hasRecipe(ArmorStationBlockEntity entity) {
        ...
        Optional<ArmorStationRecipe> match = world.getRecipeManager()
                .getFirstMatch(ArmorStationRecipe.Type.INSTANCE, inventory, world);
