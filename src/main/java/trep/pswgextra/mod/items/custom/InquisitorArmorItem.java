...
public class InquisitorArmorItem extends ArmorItem implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);


    public InquisitorArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Item.Settings builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList.containsAll(Arrays.asList(ModItems.INQUISITOR_BOOTS,
