...
public class SnowtrooperArmorItem extends ArmorItem implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);


    public SnowtrooperArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Settings builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList.containsAll(Arrays.asList(ModItems.SNOWTROOPER_BOOTS,
